...
import avatar from '../img/marc-aaron-avatar.gif';
class About extends Component {
  render() {
    return (
			<div className="about-me-paragraph">
				<img className="avatar" alt="Marc Glasser's Avatar" src={avatar}/>
